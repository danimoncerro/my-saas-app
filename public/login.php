...
<head>
    ...
    <title>Login - DaHo Tech Solutions</title>
    ...
    <main class="container my-5">
        <form action="login_process.php" method="post" class="needs-validation" novalidate>
            <div class="form-group">
                ...
                <div class="invalid-feedback">Te rugăm să introduci adresa de email.</div>
            </div>
            <div class="form-group">
                <label for="password">Parolă:</label>
                <input type="password" id="password" name="password" class="form-control" required>
                <div class="invalid-feedback">Te rugăm să introduci parola.</div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Adresa de email sau parola sunt greșite!
                </div>
